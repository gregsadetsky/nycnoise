...
class UserSubmittedEventTestCase(TestCase):
    ...
    def test_unapproved_events_are_hidden(self):
        ...
        unapproved_event = UserSubmittedEventForm(dict(starttime=timezone.now(),
                                                       title=uuid.uuid4(),
                                                       venue=self.venue.pk)).save()
    ...
    def test_approved_events_are_shown(self):
        ...
        submitted_event = UserSubmittedEventForm(dict(starttime=timezone.now(),
                                                      title=uuid.uuid4(),
                                                      venue=self.venue.pk)).save()
